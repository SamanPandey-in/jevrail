      ...
      items={[
        {
          ...
          content: (
            <div className="space-y-3">
              <CodeBlock code="jevrail install --agent claude" label="Terminal" />
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <CodeBlock code="jevrail install --agent opencode" label="Terminal" />
              <p className="text-sm text-muted-foreground">
              ...
              <CodeBlock code="jevrail install --agent opencode --project" label="Project-local variant" />
              <p className="text-sm text-muted-foreground">
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <CodeBlock code={'jevrail hook codex'} label="Terminal" />
              <p className="text-sm text-muted-foreground">
