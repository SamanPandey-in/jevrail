...
const features = [
  {
    title: "Pre-execution analysis",
    description: "Inspect commands before execution and surface the risk factors that shaped each verdict.",
    animationKey: "neural" as const,
  },
  {
    title: "Hard stops for harm",
    description: "Stop destructive operations before they reach the shell, even when an agent is moving fast.",
    animationKey: "workflow" as const,
  },
  {
    title: "Context-aware decisions",
    description: "Evaluate intent, environment, and command shape instead of relying on brittle string matching.",
    animationKey: "security" as const,
  },
  {
    title: "Explainable verdicts",
    description: "Get a human-readable reason for every allow, ask, or deny decision in the execution path.",
    animationKey: "analytics" as const,
  },
  {
    title: "Degraded-mode safe",
    description: "When policy or context is unavailable, fail closed and keep the agent from taking an unsafe shortcut.",
    animationKey: "globe" as const,
  },
  {
    title: "Works with your agent",
    description: "Drop into your existing terminal workflow with a single Go install and a small policy surface.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            >
              <span className="text-balance">A safety layer for</span>
              <br />
              <span className="text-balance">agentic software.</span>
            </h2>
            <p
